      ...
      <div class="baru">
        <section>
          <button type="button" class="btn btn-primary" onclick="window.location.href='adduser.html';">
            <i class='bx bx-plus'></i> Add Complaint
          </button>
        </section>
        ...
        <table id="myTable">
          ...
          <tr>
            <td>Sanha</td>
            <td>When scrolling the page is often slow</td>
            <td>Unresponsive web page</td>
            <td>11 March 2024</td>
            <td>
          ...
          <tr>
            <td>Eunsoo</td>
            <td>The product button cannot be pressed</td>
            <td>Website crashes</td>
          ...
          <tr>
            <td>Taeri</td>
            <td>Can't scroll the page</td>
            <td>The website is down</td>
          ...
          <tr>
            <td>Imsol</td>
            <td>Can't post photos on today's outfit menu</td>
            <td>Menu button doesn't work</td>
            <td>2 Oct 2024</td>
            <td>
              <button type="button" class="btn btn-success">
                <i class="bi bi-pencil-square"></i>
              ...
              <button type="button" class="btn btn-primary" onclick="window.location.href='imsolngeluh.html';">
                <i class="bi bi-eye"></i>
              </button>
            </td>
          </tr>

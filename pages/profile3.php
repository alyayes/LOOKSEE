...
<body>
    ...
    <div class="profile-header">
        ...
        <div class="profile-picture">
            <img src="sanh.jpg" alt="Profile">
        </div>
        <h1>Kim Sanha</h1>
        <p>@sanhhn_ | he/him</p>
        <p>Kim have no bio yet.</p>
    </div>

    <div class="tabs">
        <div class="tab active" onclick="showTab('myStyle')">Style</div>
        <div class="tab" onclick="showTab('aboutMe')">About</div>
    </div>
    ...
    <div id="aboutMe" class="content" style="display: none;">
        ...
        <div class="about-item">
            ...
            <i class='bx bxl-instagram'></i> : @hi_high_hiy<br>
        </div>
    </div>

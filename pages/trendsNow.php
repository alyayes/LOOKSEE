...
<head>
    ...
    <link rel="stylesheet" href="css/trendsNow.css">
...
<body>
    <header>
        <div class="logo-container">
            <a href="1.html" class="logo"><img src="logoo.png" href="1.html">LOOKSEE</a>
        </div>

        <ul class="navmenu">
            <li><a href="3.html">Find Your Style!</a></li>
            <!--dropdown categories-->
            <li class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <div class="dropdown-submenu">
                        ...
                        <a href="topMan.html">Top</a>
                        <a href="#">Pants</a>
                        <a href="#">Jackets</a>
                    </div>
                </div>
            <li><a href="tn.html">Trends Now</a></li>
    ...
    <!--Recommend-proucts-home-->
    <section class="recommend-product" id="recommend">
        <div class="center-text">
            <h2>Trends <Span>Now</Span></h2><br>
        </div>
        ...
        <div class="product-grid">
            ...
            <div class="product-card">
                <div class="product-image">
                    <img src="BABY BLUE 1.jpg">
                </div>
                <div class="product-details">
                    <div class="actions">
                        <button class="btn buy-now-btn" onclick="buyNow('Product 1')"><a href="https://id.shp.ee/Wgeo8g4">Style Check</a></button>
                    </div>
                </div>
            </div>
            ...
            <div class="product-card">
                <div class="product-image">
                    <img src="Copy of WHITE LABLE-7320.jpg">
                </div>
                <div class="product-details">
                    <div class="actions">
                        <button class="btn buy-now-btn" onclick="buyNow('Product 1')"><a href="https://id.shp.ee/Wgeo8g4">Style Check</a></button>

    ...
    background-color: rgb(255, 234, 247);
      ...
      <div class="baru">
        ...
        <table id="myTable">
          ...
          <tr>
            <td><img src="assets/images/sanha.jpg" alt="Sanha" width="50" /></td>
            <td>Sanha</td>
            <td>20 Feb 2024</td>
            <td>abanghasan@gmail.com</td>
            <td><span class="badge bg-gradient-quepal text-white shadow-sm w-100">Active</span></td>
            <td>
              <button type="button" class="btn btn-success">
                <i class="bi bi-pencil-square"></i>
              ...
              <button type="button" class="btn btn-primary" onclick="window.location.href='detail.html';">
                <i class="bi bi-eye"></i>
              </button>
            </td>
          </tr>
          <tr>
            <td><img src="assets/images/somin.jpg" alt="Somin" width="50" /></td>
            <td>Somin</td>
            <td>06 Mar 2024</td>
            <td>sominiee@gmail.com</td>
            <td><span class="badge bg-gradient-quepal text-white shadow-sm w-100">Active</span></td>
            <td>
              <button type="button" class="btn btn-success">
                <i class="bi bi-pencil-square"></i>
          ...
          <tr>
            <td><img src="assets/images/haein.jpg"></td>
            <td>Choiseung</td>
            <td>13 April 2024</td>
            <td>choichoi@gmail.com</td>
            <td><span class="badge bg-gradient-bloody text-white shadow-sm w-100">Deactive</span></td>
            <td>
              <button type="button" class="btn btn-success">
                <i class="bi bi-pencil-square"></i>
              </button>
              ...
              <button type="button" class="btn btn-primary" onclick="window.location.href='choiseung.html';">
                <i class="bi bi-eye"></i>
              </button>
            </td>
          </tr>
          <tr>
            <td><img src="assets/images/dal.jpg"></td>
            <td>Dal</td>
            <td>21 Mei 2024</td>
            <td>daldal@gmail.com</td>
            <td><span class="badge bg-gradient-quepal text-white shadow-sm w-100">Active</span></td>
            <td>
              <button type="button" class="btn btn-success">
                <i class="bi bi-pencil-square"></i>
          ...
          <tr>
            <td><img src="assets/images/haejun.jpg"></td>
              <td>Husein</td>
              <td>03 Mei 2024</td>
              <td>hahusein@gmail.com</td>
              <td><span class="badge bg-gradient-bloody text-white shadow-sm w-100">Deactive</span></td>
              <td>
                <button type="button" class="btn btn-success">
                  <i class="bi bi-pencil-square"></i>
          ...
          <tr>
            <td><img src="assets/images/eunsoo.jpg"></td>
              <td>Eunsoo</td>
              <td>12 Juni 2024</td>
              <td>imeunsoo@gmail.com</td>
              <td><span class="badge bg-gradient-quepal text-white shadow-sm w-100">Active</span></td>
              <td>
                <button type="button" class="btn btn-success">
                  <i class="bi bi-pencil-square"></i>
          ...
          <tr>
              <td><img src="assets/images/heedo.jpg"></td>
              <td>Taeri</td>
              <td>31 Juli 2024</td>
              <td>taerikim@gmail.com</td>
              <td><span class="badge bg-gradient-bloody text-white shadow-sm w-100">Deactive</span></td>
              <td>
                <button type="button" class="btn btn-success">
                  <i class="bi bi-pencil-square"></i>
          ...
          <tr>
            <td><img src="assets/images/yijin.jpg"></td>
            <td>Yijin</td>
            <td>19 August 2024</td>
            <td>baekyijin@gmail.com</td>
            <td><span class="badge bg-gradient-bloody text-white shadow-sm w-100">Deactive</span></td>
            <td>
              <button type="button" class="btn btn-success">
                <i class="bi bi-pencil-square"></i>
          ...
          <tr>
            <td><img src="assets/images/imsol.jpg"></td>
            <td>Imsol</td>
            <td>18 Sept 2024</td>
            <td>mamelodie@gmail.com</td>
            <td><span class="badge bg-gradient-quepal text-white shadow-sm w-100">Active</span></td>
            <td>
              <button type="button" class="btn btn-success">
                <i class="bi bi-pencil-square"></i>
          ...
          <tr>
            <td><img src="assets/images/yurim.jpg"></td>
            <td>Yurim</td>
            <td>15 Oct 2024</td>
            <td>juliako@gmail.com</td>
            <td><span class="badge bg-gradient-quepal text-white shadow-sm w-100">Active</span></td>
            <td>
              <button type="button" class="btn btn-success">
                <i class="bi bi-pencil-square"></i>
          ...
          <tr>
            <td><img src="assets/images/seungwan.jpg"></td>
            <td>Jiseu</td>
            <td>20 Nov 2024</td>
            <td>djwanseung@gmail.com</td>
            <td><span class="badge bg-gradient-bloody text-white shadow-sm w-100">Deactive</span></td>
            <td>
              <button type="button" class="btn btn-success">
                <i class="bi bi-pencil-square"></i>
          ...
          <tr>
            <td><img src="assets/images/moeum.jpg"></td>
            <td>Moeum</td>
            <td>04 Des 2024</td>
            <td>jungmoeum@gmail.com</td>
            <td><span class="badge bg-gradient-quepal text-white shadow-sm w-100">Active</span></td>
            <td>
              <button type="button" class="btn btn-success">
                <i class="bi bi-pencil-square"></i>
          ...
          <tr>
            <td><img src="assets/images/jaemi.jpeg"></td>
            <td>Jaemi</td>
            <td>14 Des 2024</td>
            <td>jojaemi@gmail.com</td>
            <td><span class="badge bg-gradient-quepal text-white shadow-sm w-100">Active</span></td>
            <td>
              <button type="button" class="btn btn-success">
                <i class="bi bi-pencil-square"></i>
          ...
          <tr>
            <td><img src="assets/images/haejo.jpeg" alt="Haejo" width="50" /></td>
            <td>Haejo</td>
            <td>22 Des 2024</td>
            <td>haejoo@gmail.com</td>
            <td><span class="badge bg-gradient-quepal text-white shadow-sm w-100">Active</span></td>
            <td>
              <button type="button" class="btn btn-success">
                <i class="bi bi-pencil-square"></i>
          ...
          <tr>
            <td><img src="assets/images/afa.jpg" alt="Haejo" width="50" /></td>
            <td>Dalfa</td>
            <td>2 Jan 2025</td>
            <td>itsmunawaroh@gmail.com</td>
            <td><span class="badge bg-gradient-quepal text-white shadow-sm w-100">Active</span></td>
            <td>
              <button type="button" class="btn btn-success">
                <i class="bi bi-pencil-square"></i>
          ...
          <tr>
            <td><img src="assets/images/nay.jpg" alt="Haejo" width="50" /></td>
            <td>Naya</td>
            <td>5 Jan 2025</td>
            <td>inaynay@gmail.com</td>
            <td><span class="badge bg-gradient-quepal text-white shadow-sm w-100">Active</span></td>
            <td>
              <button type="button" class="btn btn-success">
                <i class="bi bi-pencil-square"></i>
